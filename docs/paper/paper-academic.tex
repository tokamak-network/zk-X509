...
the user at proof generation time, not by the service. The same
...
The user decides what to reveal on a per-proof basis. Services specify
their minimum requirements via \texttt{minDisclosureMask}; the user must
meet or exceed these requirements, but may disclose additional fields
voluntarily.
